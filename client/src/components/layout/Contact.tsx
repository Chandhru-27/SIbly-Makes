...
const Contact = () => {
  ...
  return (
    <>
      <section className="relative grid xl:grid-cols-2 min-h-screen xl:content-center">
        <div
          data-label-text
        ...
        >
          ...
          <div className="flex items-center gap-5">
            <svg
              ...
              width="100"
              height="100"
              className="w-[clamp(3rem,1.8545rem+5.0909vw,10rem)] h-[clamp(3rem,1.8545rem+5.0909vw,10rem)]"
              viewBox="0 0 48 48"
            >
              <path
                fill="#304ffe"
            ...
            <a href="https://www.instagram.com/sibly.makes/" target="_blank">
              <p className="over-the-rainbow-regular text-[clamp(1.875rem,1.2614rem+2.7273vw,5.625rem)] underline text-white">
                @SiblyMakes
              </p>
            </a>
          </div>
        ...
        <div className="flex flex-col order-2 xl:order-0 h-max mr-auto w-full pt-15 ">
          <div
            style={{ position: "relative" }}
            className="flex max-xl:justify-center max-xl:items-center xl:justify-center"
          >
            <CardSwap
              skewAmount={0}
              delay={3000}
            ...
            >
              <Card className="rounded-none!">
                <img
                  src="/assets/socials/instapost1.webp"
                  className="objcet-fit w-fit"
                />
              </Card>
              <Card className="rounded-none!">
                <img
                  src="/assets/socials/instapost2.webp"
                  className="objcet-fit"
                />
              </Card>
              <Card className="rounded-none!">
                <img
                  src="/assets/socials/instapost3.webp"
                  className="objcet-fit"
                />
              </Card>
              <Card className="rounded-none!">
                <img
                  src="/assets/socials/instapost4.webp"
                  className="objcet-fit"
                />
              </Card>
              <Card className="rounded-none!">
                <img
                  src="/assets/socials/instapost5.webp"
                  className="objcet-fit"
                />
              </Card>
            </CardSwap>
